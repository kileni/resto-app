...
import RestItem from '../components/resto/restItem';
  ...
  class ProduitSelect extends Component {
    render() { 
        return ( 
           <div>
                ...
                <div class="favourite-heart text-danger position-absolute">
                    <Link to="/rest-item"><i class="icofont-heart"></i></Link></div>
                <div class="member-plan position-absolute"><span class="badge badge-dark">Promoted</span></div>
                    <Link to="/rest-item">
                        <img src="assets/img/list/1.png" class="fluid item-img"/>
                    </Link>
                </div>
                <div class="p-3 position-relative">
                <div class="list-card-body">
                <h6 class="mb-1"><Link to="/rest-item" class="text-black">World Famous</Link></h6>
                ...
                <div class="favourite-heart text-danger position-absolute"><Link to="/rest-item"><i class="icofont-heart"></i></Link></div>
                <div class="member-plan position-absolute"><span class="badge badge-dark">Promoted</span></div>
                <Link to="/rest-item">
                <img src="assets/img/list/3.png" class="fluid item-img"/>
                </Link>
                </div>
                <div class="p-3 position-relative">
                <div class="list-card-body">
                <h6 class="mb-1"><Link to="/rest-item" class="text-black">Bite Me Sandwiches</Link></h6>
                ...
                <Link to="/rest-item">
                <img src="assets/img/list/6.png" class="fluid item-img"/>
                </Link>
                </div>
                <div class="p-3 position-relative">
                <div class="list-card-body">
                <h6 class="mb-1"><Link to="/rest-item" class="text-black">The osahan Restaurant
                </Link>
                </h6>
                ...
                <div class="member-plan position-absolute"><span class="badge badge-dark">Promoted</span></div>
                <Link to="/rest-item">
                <img src="assets/img/list/8.png" class="fluid item-img"/>
                </Link>
                </div>
                <div class="p-3 position-relative">
                <div class="list-card-body">
                <h6 class="mb-1"><Link to="/rest-item" class="text-black">Polo Lounge
                </Link>
                </h6>
                <p class="text-gray mb-3">North Indian • Indian • Pure veg</p>
                ...
                <div class="member-plan position-absolute"><span class="badge badge-dark">Promoted</span></div>
                <Link to="/rest-item">
                <img src="assets/img/list/9.png" class="fluid item-img"/>
                </Link>
                </div>
                <div class="p-3 position-relative">
                <div class="list-card-body">
                <h6 class="mb-1"><Link to="/rest-item" class="text-black">Jack Fry's
                </Link>
                </h6>
                <p class="text-gray mb-3">North Indian • Indian • Pure veg</p>
                <p class="text-gray mb-3 time"><span class="bg-light text-dark rounded-sm pl-2 pb-1 pt-1 pr-2"><i class="icofont-wall-clock"></i> 15–25 min</span> <span class="float-right text-black-50"> $250 FOR TWO</span></p>
