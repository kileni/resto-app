...
class Navigation extends React.Component {
    ...
    render() { 
        return ( 
            ...
            <div class="container">
            <a class="navbar-brand" href="index-2.html"><img alt="logo" src="assets/img/logo.png"/></a>
            ...
            <a class="btn btn-success btn-block btn-lg" href="checkout.html"> Checkout</a>
             ...
             <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            <img alt="Generic placeholder image" src="assets/img/user/4.png" class="nav-osahan-pic rounded-pill"/> My Account
            </a>
            <div class="dropdown-menu dropdown-menu-right shadow-sm border-0">
